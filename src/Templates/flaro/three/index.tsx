                    ...
                    <div className="flex flex-wrap lg:items-center -m-8 lg:-m-14">
                        <div className="w-full md:w-1/2 p-8 lg:p-14">
                            <div className="relative max-w-max mx-auto lg:ml-auto lg:mr-0 overflow-hidden rounded-4xl">
                                <Image className="transform hover:scale-105 transition ease-in-out duration-1000" src={sectionData.BigImage} alt="" height={600} width={600} objectFit="contain" />
                        ...
                        <div className="w-full md:w-1/2 p-8 lg:p-14">
                            <div className="md:max-w-sm">
                                ...
                                <Text t={sectionData.BigHeading} style="bigtext mb-8 font-bold font-heading tracking-px-n leading-none" />
                                <Text t={sectionData.SubHeading} style="mb-7 paragraphRegular text-gray-900" />
                                <Text t={sectionData.Paragraph} style="paragraphRegular text-gray-600 font-medium" />
                            </div>
                        </div>
                    </div>
                </div>
